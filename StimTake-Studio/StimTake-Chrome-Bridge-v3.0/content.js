...
(() => {
  if (window.__stimTakeChromeBridgeV3Loaded) return;
  window.__stimTakeChromeBridgeV3Loaded = true;
  ...
  function startObserver(found) {
    ...
    console.info('[StimTake Bridge] v3.0 loaded. Receiver-only mode.');
    ...
    document.documentElement.dataset.stimtakeBridge = 'watching-v3';
  }
